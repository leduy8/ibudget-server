...
# * Expenses
create_category(
    {"name": "Transportation", "type": "Expense", "icon_name": "ic_transportation.png"}
)
create_category(
    {"name": "Gifts & Donation", "type": "Expense", "icon_name": "ic_gift_donation.png"}
)
create_category(
    {"name": "Food & Beverage", "type": "Expense", "icon_name": "ic_food_beverage.png"}
)
...
create_category(
    {"name": "Friends & Lover", "type": "Expense", "icon_name": "ic_friend_lover.png"}
)
create_category(
    {"name": "Entertainment", "type": "Expense", "icon_name": "ic_entertainment.png"}
)
...
create_category(
    {"name": "Education", "type": "Expense", "icon_name": "ic_education.png"}
)
create_category(
    {"name": "Investment", "type": "Expense", "icon_name": "ic_investment.png"}
)
create_category({"name": "Business", "type": "Expense", "icon_name": "ic_business.png"})
create_category(
    {"name": "Other Expense", "type": "Expense", "icon_name": "ic_other_expense.png"}
)
...
create_category(
    {"name": "Interest Money", "type": "Income", "icon_name": "ic_interest_money.png"}
)
...
create_category(
    {"name": "Other Income", "type": "Income", "icon_name": "ic_other_income.png"}
)
